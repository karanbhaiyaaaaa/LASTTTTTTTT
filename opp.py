...
API_KEY = "5d657590c83c0c147e25bb6f985d6b50"
...
"""
        ...
        if data == "admin_panel":
            ...
            if v_chat_id and v_msg_id:
                await query.answer("Sending delivery message...")
                ...
                await query.answer("❌ No delivery message/voice set for this product.", show_alert=True)
            ...
            await query.answer("🔥 Trending product & Voice cleared!", show_alert=True)
